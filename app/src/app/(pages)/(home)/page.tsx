    ...
    <main className="min-h-screen relative">
      ...
      <section className="min-h-screen relative flex flex-col justify-center pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-main-light">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-main rounded-full opacity-20 blur-3xl"></div>
          <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-main rounded-full opacity-20 blur-3xl"></div>
        </div>
